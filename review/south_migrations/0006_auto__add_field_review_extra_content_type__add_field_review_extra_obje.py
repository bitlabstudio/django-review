...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.extra_content_type'
        db.add_column(u'review_review', 'extra_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reviews_attached', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Review.extra_object_id'
        db.add_column(u'review_review', 'extra_object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.extra_content_type'
        db.delete_column(u'review_review', 'extra_content_type_id')

        # Deleting field 'Review.extra_object_id'
        db.delete_column(u'review_review', 'extra_object_id')
