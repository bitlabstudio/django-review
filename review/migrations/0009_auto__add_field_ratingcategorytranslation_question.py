...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RatingCategoryTranslation.question'
        db.add_column(u'review_ratingcategory_translation', 'question',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RatingCategoryTranslation.question'
        db.delete_column(u'review_ratingcategory_translation', 'question')
    ...
    models = {
        ...
        u'review.ratingcategorychoice': {
            'Meta': {'ordering': "('-value',)", 'object_name': 'RatingCategoryChoice'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'review.ratingcategorytranslation': {
            ...
            'question': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'})
        },
        u'review.review': {
