...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.average_rating'
        db.add_column(u'review_review', 'average_rating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.average_rating'
        db.delete_column(u'review_review', 'average_rating')
