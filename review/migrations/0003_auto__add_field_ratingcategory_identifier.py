...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RatingCategory.identifier'
        db.add_column(u'review_ratingcategory', 'identifier',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RatingCategory.identifier'
        db.delete_column(u'review_ratingcategory', 'identifier')
